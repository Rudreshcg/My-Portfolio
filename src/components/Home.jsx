...
const Home = () =>{
    ...
    return (
        ...
        <div>
            ...
            <h1 className="bouncing-letters" id="bouncing-letters">
                <span className="blast">I</span><span className="blast">'</span><span className="blast">M</span> <span className="blast">R</span><span className="blast">U</span><span className="blast">D</span><span className="blast">R</span><span className="blast">E</span><span className="blast">S</span><span className="blast">H</span>
            </h1>
        ...
        <div>
            <p className="gold-p">Expertize in Python, Django, Flask & FastApi</p>
        </div>
